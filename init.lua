-- ================================================================================================
-- Title : nvim-trim
-- Description : Minimal and uncluttered NeoVim Config
-- ================================================================================================
...
vim.opt.redrawtime = 10000                         -- max amount of time (in msec) spent redrawing the screen
vim.opt.maxmempattern = 20000                      -- max amount of memory (in kB) used for pattern matching 
